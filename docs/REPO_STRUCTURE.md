...
- `REPO_STRUCTURE.md` — Explanation of repository layout

### `spec/`
Full framework specifications.

- `UCO_v1.8_Full_Instructions.md` — Full v1.8 framework instructions
- `UCO_v1.8.1_Patch.md` — Backward-compatible structural patch for v1.8
